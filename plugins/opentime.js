  ...
  async (
    ...
    try {
      ...
      setTimeout(() => {
        ...
        _0x88f481(
          '*OPEN TIME* THE GROUP WAS OPENED BY QUEEN-ISHU-MD TO APPROVED ADMIN\n NOW MEMBERS CAN SEND MESSAGES \uD83D\uDD13'
        )
      }, _0x57aac7)
  ...
  async (
    ...
    try {
      ...
      setTimeout(() => {
        ...
        const _0x151fd3 =
          '*CLOSE TIME* GROUP CLOSED BY QUEEN-ISHU-MD AT APPROVED ADMIN\nNOW ONLY ADMIN CAN SEND MESSAGES \uD83D\uDD10'
...
cmd(
  ...
  async (
    ...
    try {
      ...
      let _0x581793 = '*TAGGING ALL ADMINS IN THE GROUP \uD83D\uDD33:*\n\n'
