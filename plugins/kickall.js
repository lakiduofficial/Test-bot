const config = require('../config'),
  ...
  sleep = (_0x2b6a08) =>
    new Promise((_0x3265f9) => setTimeout(_0x3265f9, _0x2b6a08)),
  KICK_DELAY_MS = 2000
cmd(
  {
    pattern: 'kickall',
  ...
  async (
    ...
    try {
      ...
      const _0x598864 = _0x2c0bc0.participants,
        _0x445865 = _0x598864.filter(
          (_0x2b7aad) =>
            !_0x205311.includes(_0x2b7aad.id) &&
            _0x2b7aad.id !== _0x56bac9.user.id
        )
      if (_0x445865.length === 0) {
        return _0x5b5809('No non-admin members found to kick.')
      }
      _0x5b5809(
        'Starting to kick ' + _0x445865.length + ' non-admin members...'
      )
      for (let _0x3700c2 of _0x445865) {
        try {
          await _0x56bac9.groupParticipantsUpdate(
            _0x5ab954,
            [_0x3700c2.id],
            'remove'
          )
      ...
      _0x5b5809(
        'An error occurred while trying to remove members. Please try again.'
      )
    }
  }
)
