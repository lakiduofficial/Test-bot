          ...
          if (_0x33bcb9 === '1') {
            await _0xd77fff.sendMessage(
              _0x41d115,
              {
                ...
                caption:
                  '*\xA9 ⚜️𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 : 𝐌𝐑 𝐋𝐀𝐊𝐒𝐈𝐃𝐔 𝐍𝐈𝐌𝐒𝐀𝐑𝐀 💛 \xB7 \xB7 \xB7\u2078\u2078\u2077*',
              },
              { quoted: _0x58803e }
            )
          } else {
...
cmd(
  {
    pattern: 'YUHTRGHTFGGSHFDVZFGSDVFSDVF',
    react: '\uD83D\uDCD1',
    category: 'download',
                ...
                _0x46edb0
                  ? await _0x5049fe.sendMessage(
                      _0x4a17a3,
                      {
                        ...
                        mimetype: 'video/mp4',
                        fileName: 'MR LAKIYA | ' + _0x1d0aed.title + '.mp4',
                        caption:
                          _0x1d0aed.title + ' |  *𝐇𝐀𝐒𝐇𝐈 𝐌𝐃*\n\n> 𝐇𝐀𝐒𝐇𝐈 𝐌𝐃',
                      },
                      { quoted: _0x171143 }
                    )
                  : await _0xc4807(
